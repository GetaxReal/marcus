...
<body>
        ...
        <div class="row ">
            <div class="col-lg-7 mx-auto marginshop bg-white shadow-lg fww p-3 py-4 animate__animated animate__fadeIn">
                <div class="card rounded-0">
                    <div class="card-header h4 text-white border-top border-bottom">Truemoney Gift ระบบเติมเงินอัตโนมัติ</div>
                    <div class="card-body">
                        ...
                        <div class="tab-content py-2" id="v-pills-tabContent">
                            <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
                                ...
                                <div
                                    ...
                                    <div class="">
                                        <img src="/assets/image/payment/aungpao_truewallet_01.jpg" class="img-fluid" alt="">
                                    </div>
                                </div>
    ...
    <div class="container">
        ...
        <div class="float-end">
            ...
            <a class="social-button bfacebook" href="https://ovdc.xyz/"><i class="fab fa-dev"></i></a>
        </div>
    </div>
