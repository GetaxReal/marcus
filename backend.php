            ...
            <div class="col-lg-12">
                <div class="card border-top border-bottom ">
                    <div class="card-body bg-transparent border-top border-bottom ">
                        ...
                        <div class="row mx-0">
                            <a href="/admin/backend/managewebsite"
                                class="text-decoration-none col-md-4 p-3 d-flex shadow-sm text-center border border-custom justify-content-center align-items-center">
                                <div>
                                    <div class="text-dark">จัดการหน้าเว็บ</div>
                                    <div class="h3 text-dark"><i class="fas fa-browser"></i></div>
                                </div>
                            </a>
                            <a href="/admin/backend/manageproduct"
                                class="text-decoration-none col-md-4 p-3 d-flex shadow-sm text-center border border-custom justify-content-center align-items-center">
                                <div>
                                    <div class="text-dark">จัดการสินค้า</div>
                                    <div class="h3 text-dark"><i class="fas fa-store"></i></div>
                                </div>
                            </a>
                            <a href="/admin/backend/managestock"
                                class="text-decoration-none col-md-4 p-3 d-flex shadow-sm text-center border border-custom justify-content-center align-items-center">
                                <div>
                                    <div class="text-dark">จัดการสต๊อก</div>
                                    <div class="h3 text-dark"><i class="fas fa-list"></i></div>
                                </div>
                            </a>
                        </div>

                        <div class="row mx-0">
                            <a href="/admin/backend/managemember"
                                class="text-decoration-none col-md-4 p-3 d-flex shadow-sm text-center border border-custom justify-content-center align-items-center">
                                <div>
                                    <div class="text-dark">จัดการสมาชิก</div>
                                    <div class="h3 text-dark"><i class="fas fa-user"></i></div>
                                </div>
                            </a>
                            <a href="/admin/backend/truemoneywallet"
                                class="text-decoration-none col-md-4 p-3 d-flex shadow-sm text-center border border-custom justify-content-center align-items-center">
                                <div>
                                    <div class="text-dark">ตั้งค่าเบอร์วอเล็ต</div>
                                    <div class="h3 text-dark"><i class="fas fa-wallet"></i></div>
                                </div>
                            </a>
                            <a href="http://ovdc.xyz/doc/buyer"
                                class="text-decoration-none col-md-4 p-3 d-flex shadow-sm text-center border border-custom justify-content-center align-items-center">
                                <div>
                                    <div class="text-dark">คู่มือใช้งานเว็บไชต์</div>
                                    <div class="h3 text-dark"><i class="fas fa-book"></i></div>
                                </div>
                            </a>
                        </div>
