...
<div class="offcanvas offcanvas-start" tabindex="-1" id="LMenu" aria-labelledby="LMenu">
  ...
  <div class="offcanvas-body menu-left">
    <ul class="list-group list-group-flush redz-nav-lmenu bg-transparent">
	  ...
	  <li class="list-group-item bg-transparent" onClick='location.href = "/member/history"'><i class="fas fa-history"></i> ประวัติการซื้อ</li>
	  <li class="list-group-item bg-transparent" onClick='location.href = "/member/logout"'><i class="fas fa-sign-out-alt"></i> ออกจากระบบ</li>
	<?php
		if($_SESSION["role"] == 1) {
	?>
